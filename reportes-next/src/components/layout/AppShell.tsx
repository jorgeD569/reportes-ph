...
import {
  BusquedaRapidaGlobalProvider,
  BusquedaRapidaGlobalShell,
} from '@/components/busqueda-global/BusquedaRapidaGlobalShell'
    ...
    <BusquedaRapidaGlobalProvider>
      <div className="min-h-screen overflow-x-hidden bg-app text-app">
        ...
        >
          ...
          <main className="min-w-0 flex-1 overflow-x-hidden px-4 py-6 md:px-6">
            <BusquedaRapidaGlobalShell>{children}</BusquedaRapidaGlobalShell>
          </main>
        </div>
